...
#   c) node1 mines 32 blocks, so now node 0 has 500000HASH, node 1 has 4250HASH, node2 has none.
#   d) node0 sends 601 HASH to node2, in two transactions (301 HASH, then 300 HASH).
