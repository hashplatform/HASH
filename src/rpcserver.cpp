...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Hash features */
        {"hash", "masternode", &masternode, true, true, false},
        {"hash", "listmasternodes", &listmasternodes, true, true, false},
        {"hash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hash", "masternodedebug", &masternodedebug, true, true, false},
        {"hash", "startmasternode", &startmasternode, true, true, false},
        {"hash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hash", "mnbudget", &mnbudget, true, true, false},
        {"hash", "preparebudget", &preparebudget, true, true, false},
        {"hash", "submitbudget", &submitbudget, true, true, false},
        {"hash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hash", "checkbudgets", &checkbudgets, true, true, false},
        {"hash", "mnsync", &mnsync, true, true, false},
        {"hash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> hash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:4189/\n";
}
