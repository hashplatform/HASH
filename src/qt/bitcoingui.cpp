                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Hash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Hash Core"), this);
    aboutAction->setStatusTip(tr("Show information about Hash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Hash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_black"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a hash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Hash Core help message to get a list with possible Hash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Hash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Hash network", "", count));
}
...
{
    QString strTitle = tr("Hash Core"); // default title
