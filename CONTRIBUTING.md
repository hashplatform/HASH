Contributing to Hash Core
==================================

The Hash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Hash Core project, and is not to be
confused with overall Hash Network Protocol consensus changes.

Whether a pull request is merged into Hash Core rests with the project merge
...
Patches that change Hash consensus rules are considerably more involved than
...
Where a patch set proposes to change the Hash consensus, it must have been
...
The project leader is the release manager for each Hash Core release.
