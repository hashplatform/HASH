...
In order to support loading of multiple wallets in hash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hash.cpp.
...
Changes to hash.cpp
----------------------
hash.cpp is the entry point into hash-qt, and as such, will require some minor modifications to provide hooks for
