...
Intro
-----
Hash (HASH) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Hash utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run hash-qt.exe.

Hash Core is the original Hash client and it builds the backbone of the network.
However, it downloads and stores the entire history of Hash transactions;
